...
const Untitled3 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><View style={styles.eBpqgqMo}><Text style={styles.PrMWrErY}>Lorem ipsum…</Text></View><Text style={styles.QtHRbHJt}>Lorem ipsum…</Text><ImageBackground style={styles.dNGNngJZ} source={{
      ...
      }} resizeMode="cover"></ImageBackground><FlatList style={styles.HaEwbeqf} renderItem={({
        item
      }) => <View style={styles.bIzpPaTK}></View>} ItemSeparatorComponent={() => <View style={styles.XbmMMHzB} />} data={[1, 2, 3]} keyExtractor={(item, index) => index}></FlatList><ImageBackground style={styles.IfdIQkZm} source={require("./dragon4.jpg")} resizeMode="cover"></ImageBackground></ScrollView>
    </SafeAreaView>;
};
